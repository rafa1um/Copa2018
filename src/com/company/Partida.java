...
public final class Partida {
    ...
    protected static void partidaCompleta(Equipe equipe1, Equipe equipe2) {
    ...
    protected static void partidaProrrogada(Equipe equipe1, Equipe equipe2) {
    ...
    protected static void disputaPenaltis(Equipe equipe1, Equipe equipe2) {
